...
if ( $PaymentOption == "PayPal")
{
        ...
        //'------------------------------------
        $returnURL = "https://world-converter.com/ebay/orderconfirm.php";
        ...
        //' This is set to the value entered on the Integration Assistant 
        //'------------------------------------
        $cancelURL = "https://world-converter.com/ebay/cancel.php";
		...
		$items = array();
		$items[] = array('name' => '商品データ移行サービス年間契約', 'amt' => $paymentAmount, 'qty' => 1);
