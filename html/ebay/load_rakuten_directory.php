...
$db = new dbclass();
	$username = $_SESSION["CONVERTER_USERID"];
			    insert_data($db,realpath('csv/rakuten_directory.csv'));
...
//$uploadfile="E:/develop/wasabi/ebay/rakuten_item.csv";
	...
	$doubleQ = '"';
		...
		INTO TABLE rakuten_mst
		FIELDS TERMINATED BY ',' 
		  (@rakuten_dir_id,
		@rakuten_dir_name
		)
		SET  
		rakuten_dir_id=@rakuten_dir_id,
		rakuten_dir_name=@rakuten_dir_name";
